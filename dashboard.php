        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu extended tasks-bar">
            ...
            <li>
              <a href="index.html#">
                <div class="task-info">
                  <div class="desc">The Constructor Admin Panel</div>
            ...
            <div class="row content-panel">
              <div class="col-md-4 profile-text mt mb centered">
                <div class="right-divider hidden-sm hidden-xs">
                  ...
                  <h4>290</h4>
                  <h6>FOLLOWING</h6>
                  <h4>N 6,000,000.00</h4>
                  <h6>MONTHLY EARNINGS</h6>
                </div>
              </div>
              <!-- /col-md-4 -->
              <div class="col-md-4 profile-text">
                <h3>Johnson Oroyemi</h3>
                <h6>Main Administrator</h6>
                <p>Borne out of passion to protect the integrity of Construction Industry by educating both the professionals as well as the populace. The constructor set out to bring an end to misinformation by providing proven and evidence based information as far as construction is concerned.</p>
                <br>
              ...
              <div class="col-md-4 centered">
                <div class="profile-pic">
                  <p><img src="asset/images/IMG-20200121-WA0030.jpg" class="img-circle"></p>
                  <p>
